  ...
  const fashionProducts = [
    {
      ...
      basePrice: 899,
      salePrice: 699,
      images: JSON.stringify(['/products/tshirt.png']),
      isFeatured: true,
      isBestseller: true,
    ...
    },
    {
      ...
      basePrice: 2499,
      salePrice: 1999,
      images: JSON.stringify(['/products/dress.png']),
      isFeatured: true,
      categoryId: categories[0].id,
      variants: {
        create: [
    ...
    },
    {
      ...
      basePrice: 4999,
      salePrice: 3999,
      images: JSON.stringify(['/products/backpack.png']),
      isFeatured: true,
      categoryId: categories[0].id,
      variants: {
        create: [
  ...
  const electronicsProducts = [
    {
      ...
      basePrice: 5999,
      salePrice: 4499,
      images: JSON.stringify(['/products/headphones.png']),
      isFeatured: true,
      isBestseller: true,
    ...
    },
    {
      ...
      basePrice: 45999,
      salePrice: 42999,
      images: JSON.stringify(['/products/smartphone.png']),
      isFeatured: true,
      categoryId: categories[1].id,
      variants: {
        create: [
  ...
  const homeProducts = [
    {
      ...
      basePrice: 6499,
      salePrice: 5499,
      images: JSON.stringify(['/products/coffee.png']),
      isBestseller: true,
    ...
    },
    {
      ...
      basePrice: 2499,
      salePrice: 1899,
      images: JSON.stringify(['/products/lamp.png']),
      isFeatured: true,
      categoryId: categories[2].id,
      variants: {
        create: [
  ...
  const beautyProducts = [
    {
      ...
      basePrice: 7999,
      salePrice: 6499,
      images: JSON.stringify(['/products/skincare.png']),
      isFeatured: true,
      isBestseller: true,
    ...
    },
    {
      ...
      basePrice: 5999,
      salePrice: 4999,
      images: JSON.stringify(['/products/perfume.png']),
      isFeatured: true,
      categoryId: categories[3].id,
      variants: {
        create: [
