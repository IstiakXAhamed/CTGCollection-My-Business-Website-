...
Return ONLY valid JSON.`,r=await a(t,{temperature:.2}),s=n(r,{});return{success:!0,result:s}}catch(e){return{success:!1,error:e.message}}}async function v(e){try{let t=`Analyze this order for potential fraud indicators:
...
Return ONLY valid JSON.`,r=await a(t,{temperature:.2}),s=n(r,{});return{success:!0,result:s}}catch(e){return{success:!1,error:e.message}}}r.d(t,{F0:()=>v,IM:()=>o,L:()=>l,Lm:()=>g,Mj:()=>u,OX:()=>h,Og:()=>n,Q4:()=>d,Te:()=>w,Un:()=>m,X_:()=>i,_B:()=>c,_U:()=>p,eL:()=>a,gj:()=>y,iy:()=>f,kW:()=>$,nw:()=>O,oK:()=>S,pL:()=>s})}};