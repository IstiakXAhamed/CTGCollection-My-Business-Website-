...
Return JSON with appropriate fields for ${e}. Return ONLY valid JSON.`,u=await a(c),l=n(u,{});return{success:!0,result:l}}catch(e){return{success:!1,error:e.message}}}async function $(e){try{let t=`Analyze this customer data and create a persona:
